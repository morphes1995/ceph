...
#define RGW_BUCKET_INLINED_ENTRY_LIST "bucket_inlined_entry_list"
#define RGW_BUCKET_SHARD_ACQUIRE_LEASE "bucket_shard_acquire_lease"
#define RGW_BUCKET_CLEAR_INLINED_DATA "bucket_clear_inlined_entry_data"
...
#define RGW_BUCKET_COMPLETE_ATOMIC_OP_BATCH "bucket_complete_atomic_op_batch"
#define RGW_BUCKET_COMPLETE_ATOMIC_OP_BATCH_NO_READ_ENTRY "bucket_complete_atomic_op_batch_no_read_entry"
...
#define RGW_OBJ_CHECK_MTIME_BI "obj_check_mtime_bi"

#define RGW_BI_GET "bi_get"
#define RGW_BI_GET_OBJ_STAT "bi_get_obj_stat"
#define RGW_BI_PUT "bi_put"
#define RGW_BI_RENAME "bi_rename"
#define RGW_BI_SET_ATTRS "bi_set_attrs"
