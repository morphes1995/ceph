...
class RGWRadosBucket : public RGWBucket {
  ...
  public:
    ...
    virtual bool reach_tiny_obj_inline_max_quota_threshold(optional_yield y) override;
...
public:
  ...
  static rgw::sal::RGWRadosStore *get_storage(const DoutPrefixProvider *dpp, CephContext *cct, bool use_gc_thread, bool use_lc_thread, bool quota_threads,
			       bool run_sync_thread, bool run_reshard_thread, bool use_cache = true, bool use_gc = true, bool use_detacher = true, bool run_op_cache_thread = true) {
    rgw::sal::RGWRadosStore *store = init_storage_provider(dpp, cct, use_gc_thread, use_lc_thread,
	quota_threads, run_sync_thread, run_reshard_thread, use_cache, use_gc, use_detacher, run_op_cache_thread);
    return store;
  }
  ...
  static rgw::sal::RGWRadosStore *init_storage_provider(const DoutPrefixProvider *dpp, CephContext *cct,
                                                        bool use_gc_thread, bool use_lc_thread, bool quota_threads, bool run_sync_thread,
                                                        bool run_reshard_thread, bool use_metadata_cache, bool use_gc,
                                                        bool use_detacher,  bool run_op_cache_thread);
